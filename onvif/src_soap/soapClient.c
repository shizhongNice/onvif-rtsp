...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.74 2019-05-18 07:56:25 GMT")
...
{	struct __dn__Hello soap_tmp___dn__Hello;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___dn__Hello(soap, &soap_tmp___dn__Hello, "-dn:Hello", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_wsdd__ResolveType(soap, dn__HelloResponse, "dn:HelloResponse", NULL);
	if (soap->error)
...
{	struct __dn__Bye soap_tmp___dn__Bye;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___dn__Bye(soap, &soap_tmp___dn__Bye, "-dn:Bye", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_wsdd__ResolveType(soap, dn__ByeResponse, "dn:ByeResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
{	struct __dn__Probe soap_tmp___dn__Probe;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___dn__Probe(soap, &soap_tmp___dn__Probe, "-dn:Probe", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_wsdd__ProbeMatchesType(soap, dn__ProbeResponse, "dn:ProbeResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
